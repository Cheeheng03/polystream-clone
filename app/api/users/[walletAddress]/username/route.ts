...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${process.env.NEXT_PUBLIC_TRACKER_API_URL}/users/${walletAddress}/username`;
    ...
    return NextResponse.json({ error: 'Get username API call failed' }, { status: 500 });
  }
} 